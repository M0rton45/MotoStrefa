  ...
  return (
    <main id="hero">
      <section className="py-2 px-5">
        ...
        <h3 className="font-bold text-2xl py-1">Gdzie znajdziessz wszystko dla twojego auta</h3>
      ...
      <div className="flex flex-col px-5">
        ...
        /> */}
        <a 
          href="https://www.google.com/maps/dir/?api=1&destination=Będzin+ul.+Przykładowa+12"
          target="_blank"
